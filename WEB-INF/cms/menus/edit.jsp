...
<div class="easyui-layout" data-options="fit:true">
  ...
  <form id="menus-edit-form" action="/cms/menus/${record.id}/edit" method="post">
    ...
    <div class="cms-mb20">
      <div class="cms-mb5">路径:</div>
      <input class="easyui-textbox" name="path" value="${record.path}" data-options="required:true" style="width:100%;height:32px">
    </div>
    <div class="cms-mb20">
      <div class="cms-mb5">分组:</div>
      <input class="easyui-textbox" name="organization" value="${record.organization}" data-options="required:true" style="width:100%;height:32px">
    </div>
    <div class="cms-mb20">
