...
<div class="easyui-layout" data-options="fit:true">
  ...
  <form id="menus-add-form" action="/cms/menus/new" method="post">
    ...
    <div class="cms-mb20">
      ...
      <input class="easyui-textbox" name="path" data-options="required:true" style="width:100%;height:32px">
    </div>
    <div class="cms-mb20">
      <div class="cms-mb5">分组:</div>
      <input class="easyui-textbox" name="organization" data-options="required:true" style="width:100%;height:32px">
    </div>
    <div class="cms-mb20">
