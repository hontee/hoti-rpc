...
<div class="easyui-layout" data-options="fit:true">
  ...
  <form id="mtypes-add-form" action="/cms/mtypes/new" method="post">
    <div class="cms-mb20">
    ...
    <button class="easyui-linkbutton" onclick="mtypesAddSubmitForm()" style="width:100%;height:32px">创建</button>
  </form>
  </div>
</div>
<script>
function mtypesAddSubmitForm(){
  $('#mtypes-add-form').form({
    success: function(data) {
    	CMS.addSubmitHandler(data, mtypesEL);
    }
  });
}
</script>
