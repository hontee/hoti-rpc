...
<div class="easyui-layout" data-options="fit:true">
  ...
  <form id="mtypes-edit-form" action="/cms/mtypes/${record.id}/edit" method="post">
    <div class="cms-mb20">
    ...
    <button class="easyui-linkbutton" onclick="mtypesEditSubmitForm()" style="width:100%;height:32px">更新</button>
  </form>
  </div>
</div>
<script>
function mtypesEditSubmitForm(){
  $('#mtypes-edit-form').form({
    success: function(data) {
    	CMS.editSubmitHandler(data, mtypesEL);
    }
  });
}
</script>
